...
public class HingeConstraintEditor : Editor{
	...
	private SerializedProperty _useAngleLimits;
	...
	void OnEnable(){
		...
		_useAngleLimits = serializedObject.FindProperty("useAngleLimits");
	}
	...
	public override void OnInspectorGUI(){
		...
		EditorGUILayout.PropertyField(_useAngleLimits, new GUIContent("Use Angle Limits"));
